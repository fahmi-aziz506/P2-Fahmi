...
@section('content')
    ...
    <div class="container-fluid">
        <div class="header">
            <h2 class="header-title">Tables User Waiter</h2>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb gap-2">
                    <li class="breadcrumb-item"><a href='{{ route('user.dashboard') }}'>Dashboard</a></li>
                    <span style="color: white">/</span>
                    <li class="breadcrumb-item active" aria-current="page">Tables User Waiter</li>
                </ol>
            </nav>
        </div>
        ...
        <div class="row">
            <div class="col-12">
                        ...
                        <form action="{{ $isEdit ? route('user.update', $editUser->id) : route('user.store') }}"
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-12">
                                    ...
                                    @if ($isEdit)
                                        <a style="color: white;" href="{{ route('user.index_waiter') }}"
                ...
                <div class="card">
                    <div class="card-header">
                        <h2 class="card-title" style="font-size: 25px;">Tables User Waiter</h2><br>
                        <a style="color:white;" class="btn btn-info" href="{{ route('user.laporan_waiter') }}">
                            ...
                            <tbody>
                                @foreach ($user as $d)
                                    <tr>
                                        ...
                                        <td>{{ $d->jenkel }}</td>
                                        <td><span class="btn mb-1 btn-danger"><i class="fas fa-info"></i>
                                                {{ $d->role }}</span></td>
                                        <td>
                                            @if (auth()->user()->role == 'admin' || auth()->user()->role == 'supervisor')
                                                <a style="color: white;" class="btn btn-primary"
                                                    href="{{ route('user.index_waiter', ['edit' => $d->id]) }}">
